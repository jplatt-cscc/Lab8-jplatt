...
SnailBait.prototype = {
   ...
   equipRunnerForFalling: function () {
      ...
      this.runner.fall = function (initialVelocity) {
		...
		{
			console.log("Initial Fall Velocity Pixels per Second: " + initialVelocity);
			console.log("Fall Velocity Pixels per Animation Frame: " + (initialVelocity / 30));	
		}
		snailBait.setTimeRate(0.1);
      };

      this.runner.stopFalling = function () {
		console.log("Stop Falling Last Velocity Pixels per Second" + this.velocityY);
